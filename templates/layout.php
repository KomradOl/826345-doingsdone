        ...
        <div class="content">
            <section class="content__side">
                ...
                <a class="button button--transparent button--plus content__side-button"
                   href="project_add.php" target="project_add">Добавить проект</a>
            </section>
        ...
        <header class="main-header">
          ...
          <div class="content">
            <section class="welcome">
              ...
              <a class="welcome__button button" href="enter.php">Зарегистрироваться</a>
            </section>
          </div>
          <?php endif ?>
    </div>    
...
<footer class="main-footer">
    <div class="container">
        ...
        <a class="main-footer__button button button--plus" href="auth.php">Добавить задачу</a>
