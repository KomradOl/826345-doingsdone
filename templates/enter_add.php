        ...
        <main class="content__main">
          ...
          <form class="form" action="enter.php" method="post">
            <div class="form__row">
              ...
              <?php endif?>
              <?php $classemail = isset($errors['email']) ? "form__input--error" : "" ; $value_email = isset($form['email']) ? $form['email'] : "";?>
              <input class="form__input <?=$classemail?>" type="text" name="email" id="email" value="<?=$value_email?>" placeholder="Введите e-mail">
            </div>
            ...
            <div class="form__row">
              ...
              <?php endif?>
              <?php $classpassword = isset($errors['password']) ? "form__input--error" : "" ; $value_password = isset($form['password']) ? $form['password'] : "";?>
              <input class="form__input <?=$classpassword?>" type="password" name="password" id="password" value="<?=$value_password?>" placeholder="Введите пароль">
            </div>
            ...
            <div class="form__row">
              ...
              <?php endif ?>
              <?php $classname = isset($errors['name']) ? "form__input--error" : "" ; $value_name = isset($form['name']) ? $form['name'] : "";?>
              <input class="form__input <?=$classname?>" type="text" name="name" id="name" value="<?=$value_name?>" placeholder="Введите имя">
            </div>
